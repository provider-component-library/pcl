...
public class I124Provider extends InternalProvider<Integer> {
    @Hard
    ...
    protected Integer getInternal(Request request) {
		...
		int p6Val = b30Provider.get(request);
		int p7Val = b31Provider.get(request);
		int p8Val = b35Provider.get(request);
		int p9Val = b38Provider.get(request);
		int p10Val = b40Provider.get(request);
		int p11Val = b42Provider.get(request);
		int p12Val = b44Provider.get(request);
		int p13Val = b45Provider.get(request);
		int p14Val = b46Provider.get(request);
		...
		int p18Val = i126Provider.get(request);
		int p19Val = i133Provider.get(request);
		int p20Val = i135Provider.get(request);
		int p21Val = i138Provider.get(request);
		int p22Val = i140Provider.get(request);
		int p23Val = i141Provider.get(request);
		int p24Val = i142Provider.get(request);
		int p25Val = i143Provider.get(request);
		int p26Val = i144Provider.get(request);
		int p27Val = i146Provider.get(request);
		int p28Val = i147Provider.get(request);
		int p29Val = i151Provider.get(request);
		int p30Val = i153Provider.get(request);
		...
		int p38Val = i172Provider.get(request);
		int p39Val = i173Provider.get(request);
		...
		int p45Val = i186Provider.get(request);
		int p46Val = i191Provider.get(request);
		int p47Val = i193Provider.get(request);
		int p48Val = i195Provider.get(request);
		int p49Val = i198Provider.get(request);
		int p50Val = i200Provider.get(request);
